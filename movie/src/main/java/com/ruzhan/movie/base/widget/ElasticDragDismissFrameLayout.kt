...
class ElasticDragDismissFrameLayout : ConstraintLayout {
    ...
    private var callbacks: MutableList<com.ruzhan.movie.listener.ElasticDragDismissCallback>? = null
    ...
    fun addListener(listener: com.ruzhan.movie.listener.ElasticDragDismissCallback) {
        if (callbacks == null) {
            callbacks = ArrayList()
        }
    ...
    fun removeListener(listener: com.ruzhan.movie.listener.ElasticDragDismissCallback) {
        if (callbacks != null && callbacks!!.size > 0) {
            callbacks!!.remove(listener)
        }
    }

    open class SystemChromeFader(private val activity: Activity) : com.ruzhan.movie.listener.ElasticDragDismissCallback {
