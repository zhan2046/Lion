...
public class NikolaTesla {
    ...
    static {
        ...
        introduceList.add(new Introduce(Introduce.TEXT,
                "在迈克尔·法拉第发现的电磁场理论的基础上，特斯拉在电磁场领域有着多项革命性的发明。他的多项相关的专利以及电磁学的理论研究工作是现代的无线通信和无线电的基石。", ""));

        introduceList.add(new Introduce(Introduce.IMAGE, "",
                "https://raw.githubusercontent.com/ruzhan123/Lion/master/json/api/image/nikola-tesla02.jpg"));

        introduceList.add(new Introduce(Introduce.TEXT,
                "在赢得著名的19世纪80年代的“电流战争”及在1894年成功进行短波无线通信试验之后，特斯拉被认为是当时美国最伟大的电机工程师之一。他的许多发现被认为是具有开创性的，是电机工程学的先驱。", ""));
        ...
        introduceList.add(new Introduce(Introduce.TEXT,
                "于20世纪30年代，特斯拉这时接近生命的尾声阶段。特斯拉一度变得深居简出，足不出户，独居于纽约市的Wyndham New Yorker Hotel3327房间之中，偶尔才会向新闻界发表一些不同寻常的声明。因为他举止怪异，特斯拉被普遍认为是“疯狂科学家”的原型。他对于金钱和法律事务之不在乎亦是其一生之致命伤。", ""));

        introduceList.add(new Introduce(Introduce.TEXT,
                "数家电子公司（今日美国电子业龙头的前身）联合派出一群能言善道的律师，夺走了他大部分的专利。1943年1月7日，特斯拉在穷困潦倒中过世。去世之后，特斯拉的成就并不太为当时的人所知，但是在20世纪90年代，他的公众名望出人意料地上演了王者归来。", ""));

        introduceList.add(new Introduce(Introduce.IMAGE, "",
                "https://raw.githubusercontent.com/ruzhan123/Lion/master/json/api/image/nikola-tesla04.jpg"));

        introduceList.add(new Introduce(Introduce.TEXT,
                "撇开他在电磁学和工程上的成就，阴谋论作家Robert Lomas认为特斯拉对机器人、弹道学、信息学、核子物理学和理论物理学上等各种领域有贡献。许多他的成就已伴随着一些争议被应用，去支持着许多的非主流科学，如幽浮理论。Robert Lomas视他为“创造出二十世纪的人”。", ""));
