...
object Human {
    ...
    private val TITLE = "纪录片《HUMAN》"
    private val TAG = "社会·纪录片"

    private val IMAGE = "https://raw.githubusercontent.com/ruzhan123/Lion/master/json/api/image/human-logo.png"

    private val DESC = "走访全球60个国家，让2,020位不同肤色、种族、性别的人，在镜头前诉说自己的故事。"
