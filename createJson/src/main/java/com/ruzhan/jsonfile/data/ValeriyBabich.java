 ...
 */
public class ValeriyBabich {

    private static final int ID = 2903;
    private static final String PLAY_COUNT = "18";

    private static final String TITLE = "伟大的卫国战争";
    private static final String TAG = "战争·俄罗斯·纪录片";

    private static final String IMAGE = "https://raw.githubusercontent.com/ruzhan123/Lion/master/json/api/image/valeriy-babich.jpg";

    private static final String DESC = "俄罗斯第一频道为纪念卫国战争胜利65周年，在2010年拍摄的纪录片。";
